...
export default function Login() {
    ...
    return (
        <div className="flex flex-row items-center justify-between h-screen bg-login-signup">
            ...
            <div className="flex flex-col items-center justify-between h-screen w-[37rem] px-14 bg-[#D1D0CE]">
                <div className="flex flex-col items-center justify-center h-screen w-full">
                    <h1 className="text-3xl text-center text-#556b2f tracking-wide font-normal mb-10 font-Outfit-Medium">LOG IN</h1>
